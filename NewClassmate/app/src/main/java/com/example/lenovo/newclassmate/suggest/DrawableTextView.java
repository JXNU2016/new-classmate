...
public class DrawableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public DrawableTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                drawableLeft = a.getResourceId(R.styleable.drawableText_left_Drawable, 0);
                drawableRight = a.getResourceId(R.styleable.drawableText_right_Drawable, 0);
                drawableTop = a.getResourceId(R.styleable.drawableText_top_Drawable, 0);
                drawableBottom = a.getResourceId(R.styleable.drawableText_bottom_Drawable, 0);

                drawableWidth = a.getDimensionPixelSize(R.styleable.drawableText_drawable_Width, 30);
                drawableHeight = a.getDimensionPixelSize(R.styleable.drawableText_drawable_Height, 30);
