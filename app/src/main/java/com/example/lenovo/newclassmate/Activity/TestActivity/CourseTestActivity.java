...
public class CourseTestActivity extends FragmentActivity implements ViewPager.OnPageChangeListener{
    ...
    private void initData(){
        ...
        try {
            inputStream = assetManager.open("coursetest");
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void initView() {
        ...
        questionItemAdapter.setTag("course");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {//当返回按键被按下
            AlertDialog.Builder dialog = new AlertDialog.Builder(CourseTestActivity.this);//新建一个对话框
