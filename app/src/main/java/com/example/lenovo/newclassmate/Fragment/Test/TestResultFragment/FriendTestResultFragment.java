...
public class FriendTestResultFragment extends Fragment {
  ...
  //  private ImageView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        choice = FriendTestActivity.choiceList;

        schoolName=((FriendTestActivity)getActivity()).getSchoolName();
        studentId=((FriendTestActivity)getActivity()).getStudentId();
    ...
    public void InternetRequest(final String s) {
        ...
        final StringRequest request = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("RequestType1","Friend");
                return params;
            }
        };
        //设置Tag标签
