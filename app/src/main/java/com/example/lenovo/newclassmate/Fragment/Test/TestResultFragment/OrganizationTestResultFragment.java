...
public class OrganizationTestResultFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        choice = OrganizationTestActivity.choiceList;

        schoolName=((OrganizationTestActivity)getActivity()).getSchoolName();
        studentId=((OrganizationTestActivity)getActivity()).getStudentId();
    ...
    public void InternetRequest(final String s) {
        ...
        final StringRequest request = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("RequestType1","Organization");
                return params;
            }
        };
        //设置Tag标签
